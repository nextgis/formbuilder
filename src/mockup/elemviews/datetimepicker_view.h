...
class DateTimePickerView: public ElemView
{
    Q_OBJECT

    public:

     explicit DateTimePickerView (const Core::Elem *elem);
     virtual ~DateTimePickerView ();
...
FB_ELEMVIEW_FACTORY(DateTimePickerView, DateTimePickerViewFct)
